\subsection{Analyse des Solutions Industrielles}
...
L'usage de \texttt{compareAndSwapInt} (CAS) permet à plusieurs threads de lire et modifier le journal d'ordres simultanément sans jamais se bloquer mutuellement. Le pipeline du processeur reste saturé d'instructions utiles, maximisant le débit d'ordres tout en garantissant que chaque transaction est enregistré sur disque sans aucun sacrifice de vitesse.