...
Tout ordre qui ne trouve pas immédiatement de contrepartie n'est pas rejoué : il reste dans le carnet d'ordres (à l'état \textit{resting}) en attendant un \textit{match} futur ou une annulation. Il s'agit du comportement nominal d'un carnet d'ordres, et non d'une fonctionnalité additionnelle.
...
\subsubsection{Exigences non-fonctionnelles du \textit{matching engine}}
